...
import com.example.ids2425.Repository.BundleItemRepository;
import com.example.ids2425.Repository.BundleRepository;
import com.example.ids2425.Repository.DistributoreRepository;
...
public class DistributoreService {
    ...
    public BundleDTO creaBundle(Long distributoreId, String nome, BigDecimal prezzo) {
        ...
        bundleRepo.findByDistributoreId(distributoreId).stream()
                ...
                .findAny()
                .ifPresent(b -> { throw new BusinessException("Bundle già esistente con questo nome."); });
